...
// carte intégré, pas de redirection). Premier essai : garder CETTE modale
// ouverte et remplacer son contenu par le formulaire de paiement après
// confirmation. Abandonné après un vrai test en conditions réelles (clés
// Stripe de test d'Enzo) : appeler un Server Action depuis un composant
// client déclenche de lui-même un rafraîchissement de la route en cours
// (comportement Next.js, indépendant de tout `router.refresh()` explicite
// ici) — `page.tsx` bascule donc déjà vers `PaymentView` avant que cette
// modale n'ait la moindre chance d'afficher son contenu "paiement". Pas
// un problème en pratique (le formulaire de carte s'affiche bien, sur la
// même page, jamais de redirection externe) — juste inutile de maintenir
// ici un état "payment" que personne ne voit jamais.
